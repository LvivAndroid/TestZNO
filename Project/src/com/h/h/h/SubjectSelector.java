...
public class SubjectSelector extends Activity {
	...
	public boolean checkfile(String filename , String dir)
	{
		...
		{	
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(SubjectSelector.this);
			builder.setMessage(
					"Файлу не знайдено, завантажте будь-ласка")
					.setCancelable(false)
					.setPositiveButton("OK:)",
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog, int id) {
									...
									Intent intent = new Intent(SubjectSelector.this,download.class);
